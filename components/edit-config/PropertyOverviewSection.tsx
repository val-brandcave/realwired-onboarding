...
export function PropertyOverviewSection({ fields, onFieldsChange }: PropertyOverviewSectionProps) {
        ...
        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">
              Basic property identification and location information. Click a field to edit, drag to reorder.
            </p>
          </div>
          <button
