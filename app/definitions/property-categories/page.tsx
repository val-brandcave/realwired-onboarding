...
export default function PropertyCategoriesPage() {
  ...
  return (
    <MainLayout 
      ...
      footerNav={{
        previousLabel: "Back",
        onPrevious: () => router.push('/definitions-intro'),
        nextLabel: "Next: Configure Property Fields",
        onNext: handleContinue,
        nextDisabled: categories.length === 0,
        nextTooltip: categories.length === 0 ? "Add at least one property category" : undefined,
      }}
    >
