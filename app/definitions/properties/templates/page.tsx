        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-blue-900">
              ...
              <p>After selecting a template, you'll preview the fields in a read-only view. You can either use the template as-is or enter edit mode to customize the fields, add new ones, or change their order.</p>
            </div>
          </div>
        </div>
        </div>
          ...
          <div className="sticky top-24 space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
              ...
              <p className="text-sm text-gray-700 leading-relaxed mb-3">
                Templates are pre-configured sets of property fields based on common lending scenarios. They help you get started quickly without worrying about which fields to enable.
              </p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                After selecting a template, you'll see a preview of all the fields in a form layout. You can either continue with the template as-is, or click "Edit Configuration" to customize fields, add new ones, or change their order.
              </p>
            </div>
          </div>
        </div>
