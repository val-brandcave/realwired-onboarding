...
export default function PropertyOverviewPage() {
  ...
  // Track progress - Step 1 of 2
  useEffect(() => {
    updateModuleProgress('definitions', 2, 5); // Adjusted for sub-steps
  ...
  const [fields, setFields] = useState<PropertyRecordField[]>(() => {
    ...
    // Auto-balance columns within each category
  ...
  const handleContinue = () => {
    ...
    router.push('/definitions/properties/configure/advanced');
  };
  ...
  return (
    <MainLayout 
      ...
      footerNav={{
        previousLabel: "Back to Property Categories",
      ...
      >
        ...
        <div className="text-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
            Configure Property Record - Overview
          </h1>
          <p className="text-base text-muted-foreground">
            Configure basic property identification and location fields. Click a field to customize it.
          </p>
        </div>
            ...
            <div className="bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-xl p-5 sticky top-20">
              ...
              <div className="mb-4">
                ...
                <p className="text-xs text-muted-foreground">
                  Overview fields capture essential property identification and location information. These fields help field officers and appraisers quickly identify and locate properties in your system.
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative w-full aspect-video bg-gradient-to-br from-slate-200 via-slate-300 to-slate-400 rounded-lg overflow-hidden">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <button className="w-14 h-14 bg-white/90 hover:bg-white rounded-full flex items-center justify-center transition-all hover:scale-110 shadow-lg" aria-label="Play video: Configuring Overview Fields">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-3">
                      <p className="text-white text-xs font-medium">Configuring Overview Fields</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-1.5 text-xs text-muted-foreground">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      Drag fields to reorder within columns
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-3 h-3 text-green-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      </svg>
                      Click a field to customize settings
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-3 h-3 text-green-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-xs text-blue-900">
                      ...
                      <p>System-required fields (with lock icon) cannot be hidden, but you can customize their labels and settings.</p>
                    </div>
                  </div>
                </div>
              </div>
