          ...
          <div className="bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-xl p-5 sticky top-20">
            ...
            <div className="mb-4">
              ...
              <p className="text-xs text-muted-foreground">
                Templates are pre-configured sets of request form fields based on common workflow scenarios. They help you get started with the right fields for your specific use case, organized into logical panels for better data entry flow.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="relative w-full aspect-video bg-gradient-to-br from-slate-200 via-slate-300 to-slate-400 rounded-lg overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <button className="w-14 h-14 bg-white/90 hover:bg-white rounded-full flex items-center justify-center transition-all hover:scale-110 shadow-lg" aria-label="Play video: Request Form Templates Guide">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-3">
                    <p className="text-white text-xs font-medium">Request Form Templates Guide</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs text-blue-900">
                    ...
                    <p>After selecting a template, you'll see a preview of all the fields organized by panels in a form layout. You can test dropdowns to see options, then either continue or click "Edit Configuration" to customize.</p>
                  </div>
                </div>
              </div>
            </div>
