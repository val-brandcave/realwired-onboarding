      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl border-t-4 border-[#9F2E2B] p-6 md:p-8">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900 mb-3">
            Let's Setup Your Users
          </h1>

          {/* Description as bullet points */}
          <p className="text-sm text-slate-600 mb-2">
            We've simplified team setup with a template-based approach:
          </p>
          <ul className="space-y-1.5 mb-5">
            <li className="flex items-start gap-2 text-slate-600 text-sm">
              ...
              <span>Download the team template spreadsheet</span>
            </li>
            <li className="flex items-start gap-2 text-slate-600 text-sm">
              <svg className="w-4 h-4 text-[#9F2E2B] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span>Fill in team member details and roles</span>
            </li>
            <li className="flex items-start gap-2 text-slate-600 text-sm">
              <svg className="w-4 h-4 text-[#9F2E2B] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span>Schedule a call with our CS team (optional)</span>
            </li>
            <li className="flex items-start gap-2 text-slate-600 text-sm">
              <svg className="w-4 h-4 text-[#9F2E2B] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
