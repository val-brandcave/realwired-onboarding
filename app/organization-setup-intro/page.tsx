...
export default function OrganizationSetupIntroPage() {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl border-t-4 border-[#9F2E2B] p-6 md:p-8">
          ...
          <p className="text-sm text-slate-600 mb-2">
            We'll guide you through configuring your organization profile:
          </p>
          ...
          <div className="flex items-center gap-2 px-3 py-2 bg-slate-50 rounded-lg text-slate-700 mb-6 border border-slate-200">
            ...
            <span className="text-sm">Approximate completion time – <strong className="text-slate-900">10 minutes</strong></span>
          </div>
